...
export default {
  ...
  methods: {
    ...
    checkAnnotationExist() {
      ...
      const hasSegmentation = !!currentAnnotation.annotation.segmentation.length
      const hasPaperObject = !!currentAnnotation.annotation.paper_object && !!currentAnnotation.annotation.paper_object.length
