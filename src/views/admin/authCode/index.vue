...
<template>
  <div class="app-container">
    <!-- <ProTableHeader
      ...
      @create="doAdd"
    />-->
    <el-tabs v-model="activeTab" class="eltabs-inlineblock" @tab-click="onTabClick" style="width: 168px;">
    ...
    >
      ...
      <el-table-column prop="updateTime" align="left" label="修改时间" min-width="160px">
        <template #default="scope">
          {{ parseTime(scope.row.updateTime) }}
        </template>
      </el-table-column>
      <el-table-column v-if="!isProduction" align="right" label="操作" width="370px">
        <template #default="scope">
          <el-button
...
export default {
  ...
  setup() {
    const tabActiveKey = ref("authCode")
