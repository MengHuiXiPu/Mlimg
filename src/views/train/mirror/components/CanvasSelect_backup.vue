<template>
  <div>
    <div class="box" style="margin-top: 2px;">
      <split-pane :min-percent="0" :max-percent="15" :default-percent="15" split="vertical" @resize="resizeLeft" ref="splitLeft">
        <template slot="paneL">
          ...
          <split-pane :min-percent="80" :max-percent="26" :default-percent="86" split="vertical" @resize="resizeRight" ref="splitRight">
            <template slot="paneL">
              <div style="position: relative;">
                <p-popover title="标注组件操作指南" class="tipsbutton">
...
7.选中形状，Delete删除。
                  ...
                  <p-icon type="question-circle" style="font-size: 20px; color: rgb(22, 119, 255)" class="icon"></p-icon>
                </p-popover>
...
export default {
  ...
  methods: {
    ...
    resizeRight(){
        ...
        if (splitPane.percent > 90)
            splitPane.percent = 90;
    },
